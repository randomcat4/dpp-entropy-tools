"""Exact/interval entropy-rate enclosure for the C3-M1 three-symbol object."""
...
from c3_m1_variational_boundary import Z, add, sub, neg, conj, mul
...
def main():
    ...
    out = {
        "status": "C3_M1_RATE_ENCLOSURE_COMPUTED_REVIEW_PENDING",
        "pid": os.getpid(),
        "exit_status": 0,
        ...
        "argv": sys.argv,
        "command": f"python scripts/c3_m1_rate_certificate.py --candidate candidate.json --boundary artifacts/c3_m1_boundary_M64.json --output artifacts/c3_m1_rate_n{args.n}.json --n {args.n}",
        "seed": None,
        "randomness": "none",
