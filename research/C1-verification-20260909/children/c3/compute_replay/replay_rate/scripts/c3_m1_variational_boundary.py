"""C3-M1 variational extreme-past kernel enclosures for one fixed candidate."""
...
def main():
    ...
    out = {
        "status": "C3_M1_VARIATIONAL_KERNEL_ENCLOSURES_COMPUTED_REVIEW_PENDING",
        "exit_status": 0,
        "pid": os.getpid(),
        "seed": None,
        "randomness": "none",
        ...
        "command": "python scripts/c3_m1_variational_boundary.py --candidate candidate.json --output artifacts/c3_m1_boundary_M64.json --M 64 --bits 160",
