...
- Key lemma: a sign-certified block decomposition or exact lower-dimensional
  obstruction. If equivalent to the full problem, state that explicitly.
- Fast falsification: exact event consistency and adversarial nonsymmetric
  tangent directions at symmetric centers.
...
- Fast falsification: positive full-Hessian direction followed by strict chord
  certification. A finite non-hit only eliminates the sampled objects.
- Budget: at most 512 structured centers plus 12 bounded refinements,
...
- No proof-author is eligible to certify their own candidate.

## Additional dormant seed
