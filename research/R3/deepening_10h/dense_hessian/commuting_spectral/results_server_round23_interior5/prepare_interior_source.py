"""Contract the H10 strongest spectrum toward one half to margin 0.32."""
...
def main() -> None:
    ...
    (HERE / "interior_source_margin032.json").write_text(
