"""Contract the H10 strongest spectrum toward one half to margin 0.42."""
...
def main() -> None:
    ...
    (HERE / "interior_source_margin042.json").write_text(
