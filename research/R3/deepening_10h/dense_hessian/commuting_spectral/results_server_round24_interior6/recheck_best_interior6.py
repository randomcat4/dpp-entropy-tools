"""Run the corrected high-precision gate on round-24 interior data."""
...
SPEC = importlib.util.spec_from_file_location("corrected_interior6_gate", SOURCE)
...
def sha256_with_source_alias(path: Path) -> str:
    ...
    if path.name == "source.npz" and not path.exists():
        path = HERE / "interior_source_margin042.npz"
...
if __name__ == "__main__":
    ...
    inherited.replace(HERE / "recheck_best_interior6.json")
