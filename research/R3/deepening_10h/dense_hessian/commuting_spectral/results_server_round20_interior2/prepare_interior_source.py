"""Contract the H10 strongest spectrum toward one half to margin 0.06."""
...
def main() -> None:
    ...
    (HERE / "interior_source_margin006.json").write_text(
