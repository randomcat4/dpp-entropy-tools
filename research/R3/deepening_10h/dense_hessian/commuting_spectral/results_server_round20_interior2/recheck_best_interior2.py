"""Run the corrected high-precision gate on round-20 interior data."""
...
SPEC = importlib.util.spec_from_file_location("corrected_interior2_gate", SOURCE)
...
def sha256_with_source_alias(path: Path) -> str:
    ...
    if path.name == "source.npz" and not path.exists():
        path = HERE / "interior_source_margin006.npz"
...
if __name__ == "__main__":
    ...
    inherited.replace(HERE / "recheck_best_interior2.json")
