"""Shrink the round-18 strongest spectrum to a prescribed interior margin."""
...
MODULE_PATH = HERE / "spectral_basis_refine.py"
...
def main() -> None:
    target_margin = 0.03
    source_path = HERE / "results_2" / "best_case.npz"
    ...
    (HERE / "interior_source_margin003.json").write_text(
