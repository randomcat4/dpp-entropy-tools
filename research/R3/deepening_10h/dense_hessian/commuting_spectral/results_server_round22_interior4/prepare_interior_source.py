"""Contract the H10 strongest spectrum toward one half to margin 0.22."""
...
def main() -> None:
    ...
    (HERE / "interior_source_margin022.json").write_text(
