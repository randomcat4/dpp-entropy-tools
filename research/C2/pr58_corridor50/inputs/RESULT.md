...
This criterion is strictly weaker than the sign condition `W>=0`: it can hold with `E[y psi]<0`.
...
This is a genuine compensation criterion: unlike `W>=0`, it pays for a negative signed term using the retained full Fisher/quadratic contribution.
...
inside an interval of width `< 5.83e-83` whose upper endpoint is
