...
2026-09-09 11:38 UTC: RUNNING, analytic formula audit and independent structural review complete; global sign remains open.
...
- Root hand-derived an exact positive seed at `(mu,nu,r,u)=(0,0,0,1/2)`, using strict diagonal dominance of the reduced four-dimensional matrix. The candidate in `structure/POSITIVE_SEED.md` is awaiting nonauthor review and does not supply global determinant nonvanishing.
