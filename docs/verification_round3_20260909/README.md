...
| --- | --- |
| [PR41 dependency/quantifier map](pr41_dependencies.md) | `6fd61dcd299417fc3a4eab3af682c03dd816b670`: mapping complete, with no material source/summary mismatch; all new proof claims still need C1's first pass and risk-based supplemental review. |
| [PR43 original version map](pr43_initial_version_map.md) | `4e1369ef2a59ccfaba3ca8fce95d85e78857bf78`: version-entry NEEDS_FIX because the current index omitted the separately supplied three-point/3+3 claims. Historical report retained unchanged. |
| [PR43 v3.1 supplement](pr43_v31_version_supplement.md) | `7bd5962bbb2020ce47fbe286adda7dfe02f9645d`: the declaration-level ambiguity is resolved; E-H now explicitly include those author claims. Interface acceptance is not mathematical acceptance. |
| [Initial computation-handoff review](handoff_initial_readiness.md) and [v3.1 supplement](handoff_v31_supplement.md) | The old-D/current-G directed-flow LP is one unchanged numerical object. New Markdown fixes the handoff and command list, but unchanged JSON/helper fields still advertise obsolete symmetric conductances. C2 has acknowledged that it uses the directed equations and records the state-bit convention. |
