...
| New finite-range true local entropy-rate theorem, one added 473-line file | `abdd660a6c7761c7a8a53cb8671b4d2543530a5c` | C1 FIRST accepted; C3 separate source-only SECOND running |
