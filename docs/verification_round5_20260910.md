...
PR82、PR88、PR91 与 PR95 已在冻结头完成限定整合；“源码进入 main”不等于作者包内每个主张或输出获证。精确接受边界分别见 [PR82](verification_round5_20260910/accepted_pr82.md)、[PR88](verification_round5_20260910/accepted_pr88.md)、[PR91](verification_round5_20260910/accepted_pr91.md) 与 [PR95](verification_round5_20260910/accepted_pr95.md)。
